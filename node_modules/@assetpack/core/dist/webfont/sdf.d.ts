...
export declare function sdfFont(options?: Partial<SDFFontOptions>): AssetPipe<SDFFontOptions, "nc" | "nomip" | "font", string>;
export declare function msdfFont(options?: Partial<SDFFontOptions>): AssetPipe<SDFFontOptions, "nc" | "nomip" | "font", string>;
